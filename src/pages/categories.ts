export const categoryData = {
  ...
  "rust-for-noobs": {
    name: "Rust for Noobs",
    image: "/images/categories/rust-for-noobs-cover.png",
    desc: "<p>This series dives into <strong>Rust</strong>, a language built for <strong>speed, safety, and zero-footgun coding</strong>. We’ll break down <strong>ownership, borrowing, lifetimes</strong>, and all the things that make Rust both powerful and unique. Expect <strong>hands-on examples, practical explanations</strong>, and just enough theory to actually understand what’s happening under the hood. Whether you’re here for performance, reliability, or just curious why Rust keeps showing up everywhere, this is your starting point.</p>",
  },
};
